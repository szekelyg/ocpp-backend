      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="max-w-md w-full space-y-6">
          <div className="card cardBody text-center space-y-4">
            <div className="w-14 h-14 rounded-full bg-brand-panel border border-brand-line text-ink-soft flex items-center justify-center mx-auto text-2xl">
              ✕
            </div>

            <div>
              <div className="text-xl font-semibold text-ink">Fizetés megszakítva</div>
            ...
            <div className="rounded-xl bg-brand-panel p-3 text-xs text-ink-soft text-left">
              Ha a fizetés tévesen szakadt meg, kérjük próbálja újra, vagy vegye
              fel a kapcsolatot ügyfélszolgálatunkkal a
              <a href="mailto:szerviz@energiafelho.hu" className="text-brand-action ml-1">
